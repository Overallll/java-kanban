...
public class TaskManagerTest {
    ...
    public void testAddSubtask() {
        ...
        // Проверяем, что подзадача добавлена к эпикам
        ...
        // Проверяем, что подзадача найдена по ID
    ...
    // Тест управления историей просмотров
    @Test
    ...
    // Тест ограничения размера истории (не более 10 задач)
    @Test
    public void testHistoryManagerSizeLimit() {
        // Добавляем больше 10 задач, чтобы проверить, что остаются только последние 10
        for (int i = 1; i <= 15; i++) {
